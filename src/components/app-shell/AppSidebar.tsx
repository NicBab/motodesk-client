...
export function AppSidebar() {
  ...
  return (
    <aside className="motodesk-sidebar flex h-screen w-64 shrink-0 flex-col border-r">
      <div className="flex h-20 items-center border-b border-zinc-800 px-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="motodesk-sidebar-muted text-[10px] uppercase tracking-widest">
              Shop Management
            </p>
          </div>
        </div>
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-4">
              ...
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition ${
                  active
                    ...
                    : "motodesk-sidebar-hover text-zinc-400 hover:text-white"
                }`}
              >
        ...
        0 ? (
          <div className="mt-3 space-y-1 border-t border-zinc-800 pt-3">
            <p className="motodesk-sidebar-muted mb-1 px-3 text-[10px] font-semibold uppercase tracking-widest">
              Open ROs
            </p>

            {openRepairOrders.map(
              (
                repairOrder,
              ) => {
                const active =
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="motodesk-sidebar-muted truncate text-xs">
                        {
      ...
      <div className="border-t border-zinc-800 px-5 py-4">
        <p className="motodesk-sidebar-muted text-[10px] tracking-wide">
          © 2026 MotoDesk
        </p>
      </div>
    </aside>
