...
//************************************************************** */
export function CustomerDialogShell({
  title,
  description,
  children,
  onClose,
}: CustomerDialogShellProps) {
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/40 backdrop-blur-[1px]">
      ...
      <aside className="relative z-10 h-full w-full max-w-2xl overflow-y-auto bg-zinc-50 shadow-2xl">
